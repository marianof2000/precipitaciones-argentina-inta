        ...
        samples.append(
            {
                ...
                "archivo_observaciones": original["archivo_origen"],
...
def create_audit_report(
    ...
    report: dict[str, Any] = {
        ...
        "archivo_fuente": summary.source_file,
        "fuentes_procesadas": summary.datasets_processed,
        "fuentes_con_error": summary.datasets_with_errors,
        "detalle_errores": summary.dataset_errors,
        "estaciones_catalogo": summary.stations_catalog,
        "estaciones_con_observaciones": summary.stations_observed,
        "ids_csv_sin_catalogo": summary.unknown_station_ids,
        "diferencias_manifiesto": summary.manifest_differences,
        "verificacion_sha256": config.VERIFY_CSV_SHA256,
